			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<select name="desa" id="desa" class="form-control">
						...
						<option value="Paserean">Paserean</option>
						<option value="Buddan">Buddan</option>
						<option value="Kejawan">Kejawan</option>
						<option value="Morleke">Morleke</option>
						<option value="Pongbaru">Pongbaru</option>
						<option value="Kampung Langgar">Kampung Langgar</option>
					</select>
				</div>
			</div>
