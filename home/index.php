			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI DATA KEPENDUDUKAN DESA SUKOLILO TIMUR</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text">
					<div class="text-sm">SISPENDUK SUKOLILO TIMUR</div>
				</span>
			</a>
					...
					<ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=report-pend" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Penduduk</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=report-kartu" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Kartu Keluarga</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=report-lahir" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Lahir</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=report-mendu" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Meninggal</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=report-datang" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pendatang</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=report-pindah" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pindah</p>
									</a>
								</li>
					...
					if (isset($_GET['page'])) {
						...
						switch ($hal) {
							...
							case 'suket-pindah':
								...
								//report
							case 'report-pend':
								include "../report/report_pend.php";
								break;
							case 'report-kartu':
								include "../report/report_kartu.php";
								break;
							case 'report-lahir':
								include "../report/report_lahir.php";
								break;
							case 'report-mendu':
								include "../report/report_mendu.php";
								break;
							case 'report-datang':
								include "../report/report_datang.php";
								break;
							case 'report-pindah':
								include "../report/report_pindah.php";
								break;
		...
		$(document).ready(function() {
			...
			navLinks.each(function() {
				if (currentUrl.includes($(this).attr('href'))) {
					...
					if (parentNavItem.hasClass('has-treeview')) {
	...
	<script>
		$(document).ready(function() {
			...
			$('.nav-link').each(function() {
				if ($(this).attr('href') == '?page=' + currentPage) {
					$(this).addClass('nav-link-clicked');
				}
			});

			$('.nav-link-clicked').parent().addClass('menu-open');
			$('.nav-link-clicked').parent().parent().css('display', 'block');
		});
